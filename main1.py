...
jokes = [
    ...
    "Why do travellers always feel warm? Because of their hot spots!"
]
...
def show_help():
    ...
    print(Fore.CYAN + "Type 'exit' or 'bye' to leave")
...
def chat():
    ...
    while True:
        ...
        if "recommend" in user_input or "suggest" in user_input:
            ...
            print(Fore.CYAN + "TravelBot: Safe journeys! Goodbye!")
            break
        else:
            print(Fore.RED + "TravelBot: Could you please rephrase that?")
